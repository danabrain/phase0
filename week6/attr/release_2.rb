...
class Profile
  ...
  #This is new!  It allows us to read @age from outside the class, and takes the place of the def what_is_age method that returned @age.
  ...
  #this code is no longer needed. ----> because of attr_reader
  # def what_is_age
  #   @age
  # end
