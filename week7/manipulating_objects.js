...
// I couldn't get adding the children to work, because I was trying to define each child as a variable and then somehow assign them to the children object from outside the Terah object.  Eventully, I realized I could use an object literal notation to make the children inside the children object.

// // How difficult was it to add and delete properties outside of the object itself?

// Not too bad, except children (see above).

// // What did you learn about manipulating objects in this challenge?

// I learned a lot!  That I can alter an object, assign a property in another object to a value in the first object.
//
//
//
//
